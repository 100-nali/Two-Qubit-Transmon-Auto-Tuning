...
def fidelity_fn(parameters):
    I1_p, Q1_p, I2_p, Q2_p = parameters # each is of length 3; 12 parameters overall
    ...
    fig = qpt_plot_combined(chi_ideal_X, op_label, r'$X')
    plt.show()
